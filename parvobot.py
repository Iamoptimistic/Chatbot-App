...
faq = {
    ...
    "how can it be prevented": "Vaccination is the most effective way to prevent parvovirus. Puppies should follow a vaccination schedule starting at 6–8 weeks.",
}
